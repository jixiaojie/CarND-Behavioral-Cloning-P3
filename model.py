...
model.add(Lambda(lambda x: x/127.5 - 1.,
        input_shape=(row - 70 , col, ch),
        output_shape=(row - 70, col, ch)))
...
model.add(Dense(1164, kernel_initializer = TruncatedNormal(mean=0.0, stddev=0.05, seed=None), bias_initializer='zeros'))
model.add(Activation('relu'))
